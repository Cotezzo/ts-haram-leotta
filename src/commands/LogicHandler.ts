...
const logicHandler: Commands<Command> = {
    ...
    changelog: {
        ...
        fn: () => { return { embeds: [new EmbedBuilder()
            ...
            .addFields(
                ...
                {name: "Fix attempt", value:"Added a fix for destroyed connections and files... I hope is works."},
    ...
    help: {
        ...
        fn: (cmdName: string) => {
            const embed = new EmbedBuilder().setColor(process.env.embedColor as ColorResolvable);
